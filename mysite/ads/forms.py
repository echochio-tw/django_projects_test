...
class CommentadForm(forms.Form):
    commentad = forms.CharField(required=True, max_length=500, min_length=3, strip=True)
...
class CreateForm(forms.ModelForm):
    ...
    class Meta:
       ...
       # fields = ['title', , 'text', 'picture']  # Adsture is manual
