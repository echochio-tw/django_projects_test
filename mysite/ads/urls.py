...
urlpatterns = [
    ...
    path('ad/<int:pk>/commentad',
        views.CommentadCreateView.as_view(), name='ad_commentad_create'),
    path('commentad/<int:pk>/delete',
        views.CommentadDeleteView.as_view(success_url=reverse_lazy('ads')), name='ad_commentad_delete'),
    ]
